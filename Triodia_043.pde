...
int[] sX = new int[maxNumberOfPerimeters]; // store starting x perimeter point for all hummocks
int[] sY = new int[maxNumberOfPerimeters]; // store starting y perimeter point for all hummocks
